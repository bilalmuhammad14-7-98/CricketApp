...
import UmpireStatsForRecruiter from "../../components/PlayerProfile/UmpireStatsForRecruiter";
...
const UmpireProfileForRecruiter = (props) => {
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <View style={{ marginTop: 20 }}>
            ...
            {gamesTab == 1 && (
              <UmpireStatsForRecruiter profile={params?.profile} />
            )}
...
export default withToast(UmpireProfileForRecruiter);
