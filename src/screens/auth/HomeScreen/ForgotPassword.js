  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.pass}>
        <Text style={[styles.text2, { color: colors.heading }]}>Foot</Text>

        <Text style={[styles.text2, { color: colors.heading }]}>Password?</Text>

        <Text style={styles.text3}>
          Don't worry it happens! Please enter the
        </Text>
        <Text style={styles.text3}>address associated with your account.</Text>
      </View>
