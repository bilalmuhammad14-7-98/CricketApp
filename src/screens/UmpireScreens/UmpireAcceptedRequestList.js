      ...
      >
        <View style={styles.cardView}>
          <View style={styles.logo}>
            ...
            <Text
              numberOfLines={1}
              ellipsizeMode="tail"
              style={[styles.text, { marginVertical: sizes.m5 }]}
            >
              VS
            </Text>
            <Avatar.Image
        ...
        >
          ...
          >
            ...
            <Text numberOfLines={1} ellipsizeMode="tail" style={styles.text}>
              Sender Team: {item?.request_sender_team_id}
            </Text>

            <Text numberOfLines={1} ellipsizeMode="tail" style={styles.text}>
              Rival: {item.request_receiver_name}
            </Text>
            <Text numberOfLines={1} ellipsizeMode="tail" style={styles.text}>
              Rival Team: {item?.requested_receiver_team_name}
            </Text>
            <Text numberOfLines={1} ellipsizeMode="tail" style={styles.text}>
              Match: {item?.match_date_time}
            </Text>
            <Text numberOfLines={1} ellipsizeMode="tail" style={styles.text}>
